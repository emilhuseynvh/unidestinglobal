...
const navItems = [
  ...
  { label: "Scheldue", path: "/schedule" },
  { label: "Achivements", path: "/achievements" },
    ...
    <header className="w-full border-b border-[#e9eaeb] bg-white relative z-50">
      <div className="max-w-[1440px] mx-auto flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-20 h-16 md:h-[72px]">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            ...
            {cartOpen && (
              <div className="absolute right-0 top-full mt-1 w-[360px] bg-white border border-[#e9eaeb] rounded-2xl shadow-[0px_12px_40px_0px_rgba(0,0,0,0.12)] z-50 p-5 flex flex-col gap-4">
                ...
                <Link to="/cart" className="w-full h-11 bg-[#007aff] rounded-full text-white text-[15px] font-medium hover:bg-[#0066d6] transition-colors flex items-center justify-center">
                  Go to cart
                </Link>
              </div>
            )}
            ...
            {notifOpen && (
              <div className="absolute right-0 top-full mt-1 w-[400px] bg-white border border-[#e9eaeb] rounded-2xl shadow-[0px_12px_40px_0px_rgba(0,0,0,0.12)] z-50 overflow-hidden">
                ...
                <div className="border-t border-[#e9eaeb] px-5 py-3">
                  <Link to="/settings/notifications" className="w-full h-10 border border-[#d5d7da] rounded-lg text-[14px] font-medium text-[#181d27] hover:bg-[#f9f9f9] transition-colors flex items-center justify-center">
                    All notifications
                  </Link>
                </div>
              </div>
          ...
          <Link to="/settings" className="hidden sm:flex items-center justify-center size-10 rounded-lg hover:bg-[#f5f5f5] transition-colors">
            <SettingsIcon />
          </Link>
          <div
          ...
          >
            ...
            {profileOpen && (
              <div className="absolute right-0 top-full mt-1 w-[220px] bg-white border border-[#e9eaeb] rounded-xl shadow-[0px_12px_40px_0px_rgba(0,0,0,0.12)] z-50 py-2">
                ...
                <Link to="/help" className="w-full text-left px-4 py-2.5 text-[14px] font-medium text-[#181d27] leading-5 hover:bg-[#f9f9f9] transition-colors flex items-center gap-2">
