      ...
      <div className="p-5 flex flex-col gap-5">
        <div className="max-w-[649px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            <span className="text-[11px] font-medium text-[#5b616d] uppercase tracking-[2px] leading-3">Visibility & Access</span>
            <div className="flex flex-col gap-3">
              <ToggleRow title="Course published" desc="Visible to students and searchable on Unidestin" enabled={settings.published} onChange={() => toggle("published")} />
              <ToggleRow title="Free preview enabled" desc="Allow students to preview 2 lessons before purchasing" enabled={settings.freePreview} onChange={() => toggle("freePreview")} />
              <ToggleRow title="Reviews visible" desc="Show student reviews publicly on course page" enabled={settings.reviewsVisible} onChange={() => toggle("reviewsVisible")} />
              <ToggleRow title="Certificate on completion" desc="Certificate on completion" enabled={settings.certificate} onChange={() => toggle("certificate")} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              <ToggleRow title="New enrollment alerts" desc="Get notified when a student enrolls" enabled={settings.enrollmentAlerts} onChange={() => toggle("enrollmentAlerts")} />
              <ToggleRow title="New review alerts" desc="Get notified when a student leaves a review" enabled={settings.reviewAlerts} onChange={() => toggle("reviewAlerts")} />
              <ToggleRow title="Completion alerts" desc="Get notified when a student completes the course" enabled={settings.completionAlerts} onChange={() => toggle("completionAlerts")} />
            </div>
          </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-3">
                <div className="flex-1 flex flex-col gap-1">
                  <label className="text-base font-medium text-[#5b616d] leading-6 px-0.5">Course Title</label>
                  <input type="text" defaultValue="IB Biology HL — Complete Exam Preparation 2026" className="bg-white border border-black/[0.06] rounded-xl h-12 px-3 text-sm text-[#5b616d] leading-6 outline-none" />
                </div>
                <div className="w-[131px] flex flex-col gap-1">
                  <label className="text-base font-medium text-[#5b616d] leading-6 px-0.5">Level</label>
                  <div className="bg-white border border-black/[0.06] rounded-xl h-12 px-3 flex items-center justify-between">
                    <span className="text-sm text-[#5b616d] leading-6">Advanced</span>
              ...
              <div className="flex gap-6">
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div className="bg-white border border-black/[0.09] rounded-xl h-12 px-3 flex items-center justify-between backdrop-blur-[12px] shadow-[0px_2px_1.5px_0px_rgba(0,0,0,0.03)]">
                    <span className="text-base text-[#8c929c] leading-6">Biology</span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M7 4l3 3 3-3M7 16l3-3 3 3" stroke="#5b616d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                </div>
                <div className="flex-1 flex flex-col gap-1">
                  <label className="text-sm font-medium text-[#5b616d] leading-5 px-0.5">Available Courses</label>
                  <div className="bg-white border border-black/[0.09] rounded-xl h-12 px-3 flex items-center justify-between backdrop-blur-[12px] shadow-[0px_2px_1.5px_0px_rgba(0,0,0,0.03)]">
                    <span className="text-base text-[#8c929c] leading-6">Select course</span>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M7 4l3 3 3-3M7 16l3-3 3 3" stroke="#5b616d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-black/[0.03] backdrop-blur-[12px] rounded-[28px] p-3">
            <div className="bg-white rounded-2xl p-3 flex flex-col gap-3 shadow-[0px_1px_1px_0px_rgba(0,0,0,0.03),0px_3px_3px_0px_rgba(0,0,0,0.03),0px_20px_20px_0px_rgba(0,0,0,0.03),0px_32px_32px_0px_rgba(0,0,0,0.03),0px_56px_56px_0px_rgba(0,0,0,0.03)]">
