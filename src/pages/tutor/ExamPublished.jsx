    ...
    <div className="px-6 lg:px-10 py-6 flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
      <div className="flex flex-col items-center gap-4 max-w-[376px]">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-sm text-[#8c929c] leading-5 text-center">Your exam is now visible to assigned students and will activate at the scheduled time.</p>
        </div>
        <div className="flex gap-3 mt-4">
          ...
          <Link to="/tutor/exams" className="h-10 px-[10px] rounded-[10px] bg-[#007aff] backdrop-blur-[12px] border border-black/[0.09] text-sm font-medium text-white flex items-center justify-center shadow-[0px_1px_1px_-0.5px_rgba(0,0,0,0.03),inset_0px_3px_3px_0px_rgba(255,255,255,0.12)] no-underline">
            Back to My Exams
          </Link>
        </div>
      </div>
