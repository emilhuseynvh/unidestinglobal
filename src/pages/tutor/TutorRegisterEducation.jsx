...
const PlusIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path d="M10 4.167v11.666M4.167 10h11.666" stroke="#0a0c11" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
          ...
          <div className="flex-1 bg-white rounded-[20px] px-6 sm:px-8 lg:px-11 pt-8 lg:pt-11 pb-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="border border-black/[0.06] rounded-xl min-h-[48px] p-3 flex items-center focus-within:border-[#007aff] focus-within:border-2 transition-colors">
                      <input type="text" value={form.degree} onChange={handleChange("degree")} placeholder="Bachelor, Master, PHD" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1">
                    <label className="text-base font-medium text-[#5b616d] leading-6 px-0.5">Field of Study</label>
                    <div className="border border-black/[0.06] rounded-xl min-h-[48px] p-3 flex items-center focus-within:border-[#007aff] focus-within:border-2 transition-colors">
                      <input type="text" value={form.fieldOfStudy} onChange={handleChange("fieldOfStudy")} placeholder="e.g Mathematics" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" />
                    </div>
                  </div>
                </div>
                <div className="flex flex-col gap-1">
                  ...
                  <div className="border border-black/[0.06] rounded-xl min-h-[48px] p-3 flex items-center focus-within:border-[#007aff] focus-within:border-2 transition-colors">
                    <input type="text" value={form.institution} onChange={handleChange("institution")} placeholder="University name" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" />
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="border border-black/[0.06] rounded-xl min-h-[48px] p-3 flex items-center gap-2 focus-within:border-[#007aff] focus-within:border-2 transition-colors">
                      <CalendarIcon />
                      <input type="text" value={form.startDate} onChange={handleChange("startDate")} placeholder="Select date" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" onFocus={(e) => e.target.type = "date"} onBlur={(e) => { if (!e.target.value) e.target.type = "text" }} />
                    </div>
                  </div>
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="border border-black/[0.06] rounded-xl min-h-[48px] p-3 flex items-center gap-2 focus-within:border-[#007aff] focus-within:border-2 transition-colors">
                      <CalendarIcon />
                      <input type="text" value={form.endDate} onChange={handleChange("endDate")} placeholder="Select date" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" onFocus={(e) => e.target.type = "date"} onBlur={(e) => { if (!e.target.value) e.target.type = "text" }} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-5">
                <span className="text-base font-medium text-[#0a0c11] leading-6">Upload your diplom</span>
                <div
              ...
              <button className="flex items-center gap-2 text-base font-medium text-[#0a0c11] self-start">
                <PlusIcon />
              ...
              <div className="flex flex-col gap-4 items-center">
                <button
                  onClick={() => navigate("/tutor/register/training")}
