...
const RadioOption = ({ selected, title, desc, onClick }) => (
  <button
    ...
    className={`flex-1 border rounded-xl p-4 flex gap-2 items-start text-left transition-colors ${
      selected ? "border-[#007aff]" : "border-[#e9eaeb] bg-white"
    }`}
  >
    <div className="pt-0.5 shrink-0">
      {selected ? (
        <div className="w-[18px] h-[18px] rounded-full border-[5px] border-[#007aff]" />
      ) : (
        <div className="w-[18px] h-[18px] rounded-full border-2 border-black/[0.09] bg-gradient-to-b from-[#f2f2f4] to-white" />
      )}
    </div>
...
const TutorRegisterTraining2 = () => {
  const navigate = useNavigate()
  const [selectedLanguages, setSelectedLanguages] = useState(["Azerbaijani"])
  const [languageSearch, setLanguageSearch] = useState("")
  const [teachMethod, setTeachMethod] = useState("online")
  const [teachTarget, setTeachTarget] = useState("1-on-1")
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="border border-black/[0.09] rounded-xl min-h-[48px] p-3 flex items-center justify-between bg-white shadow-[0px_0px_0px_3px_rgba(0,122,255,0.2)]">
                    <span className="text-base font-medium text-[#0a0c11] leading-6 px-1">{subject || "Select subject"}</span>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="border border-black/[0.09] rounded-xl min-h-[48px] p-3 flex items-center justify-between bg-white shadow-[0px_2px_1.5px_0px_rgba(0,0,0,0.03)]">
                    <input type="text" value={availableCourse} onChange={(e) => setAvailableCourse(e.target.value)} placeholder="Select course" className="w-full text-base text-[#0a0c11] leading-6 outline-none placeholder:text-[#8c929c] px-1" />
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="shrink-0"><path d="M5 7.5l5 5 5-5M5 12.5l5-5 5 5" stroke="#5b616d" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                </div>
                <button className="h-12 rounded-xl border border-black/[0.06] bg-white text-base font-medium text-[#5b616d] shadow-[0px_2px_1.5px_0px_rgba(0,0,0,0.03)] hover:bg-[#f5f5f5] transition-colors flex items-center justify-center gap-2 self-start px-4">
                  ...
                  <div className="bg-[#f2f2f4] px-5 py-6 flex flex-col gap-5 max-h-[315px] overflow-y-auto">
                    ...
                    <div className="bg-white rounded-xl p-4 flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="text-sm text-[#8c929c] leading-5 flex flex-col gap-4">
...
export default TutorRegisterTraining2
